...
The short version — the full decision log with context and trade-offs is in [DECISIONS.md](DECISIONS.md). What's next lives in [ROADMAP.md](ROADMAP.md); the full deploy runbook in [docs/DEPLOY.md](docs/DEPLOY.md); the complete engineering deep-dive in [docs/TECHNICAL.md](docs/TECHNICAL.md); AI-assisted-development house rules in [CLAUDE.md](CLAUDE.md).
